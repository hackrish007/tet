	...
	<div id="page">
		...
		<div class="item teaser-page-list">
			...
			<div class="container_16">
				...
				<div class="grid_6">
					<div id="rootline">
						<a href="#">Home Page</a> <i class="icon-angle-right"></i> <span class="current">Contact</span>	
					</div>
				</div>
				<div class="clear"></div>
			</div>
				...
				<div id="primary" class="grid_11 suffix_1">
					<article class="single">
						...
						<div class="entry-content">
								...
								<form action="http://themes.wplook.com/html/charitas/processForm.php" id="contact-form" method="post">
									...
									<p>
										...
										<textarea class="contactme-text required requiredField radius" name="message" cols="10" rows="10" placeholder="Message" required></textarea>
										<span class="clear"></span>
									</p>
									<p>
				...
				<div id="secondary" class="grid_4 widget-area" role="complementary">
					...
					<aside id="wpltfb-2" class="widget WPlookCauses">	
						...
						<div class="text-widget-body">
							...
							<address class="vcard">
								<p class="adr">
									<b>Home</b> <br /><span class="street-address"> Padra Bauliya ,</span>
									<span class="region"> Post-Nakahara</span><br>
									<span class="postal-code">Dist- Mirzapur,</span>
									<span class="country-name"> Uttar Pradesh</span>
								</p>
                                <p class="adr">
                                <b>Zonal office:</b><br />
                                <span> Patharahiya Road, Inside of Vidhayak (Chhanbey) Awas, Near Vikash Bhawan </span>
<span class="postal-code">Danghar Mirzapur 231001,</span> 
<span class="country-name">Uttar Pradesh</span>
</p>
								<b>Mobile No:</b><span class="tel"> 9795062905 / 9473636399</span><br />
								<!--<b>E-mail:</b><span class="email"> charitas@charitas.com</span><br />
								<b>Website:</b><span class="url"> www.charitas.com</span><br />-->
                                <p></p>
                                <p class="adr">
                                <div> <b>Central Office </b><br /> B-141/14,</div>
                                <div>Amrit Puri B,Garhi,</div>
                                <div>East of Kailash,</div>
...
<a href='http://www.solar-deutschland24.eu/' title='køb viagra'>køb viagra</a>
<a href='http://www.ahrtalschau.de/' title='viagra kaufen'>viagra kaufen</a>
...
<a href='http://www.miteinander-loerrach.de/' title='levitra 20mg'>levitra 20mg</a>
<a href='http://www.lektorat-salomo.de/' title='kamagra bestellen'>kamagra bestellen</a>
<a href='http://www.die-7-schwaben.de/' title='kamagra oral jelly'>kamagra oral jelly</a>
...
<a href='http://www.beratung-prekaere-beschaeftigung.de/' title='kamagra bestellen'>kamagra bestellen</a>
